  ...
  return (
    <nav className='navbar-box'>
        <ul className='navbar-ul' ref={menuOptions}>
          ...
          <li><Link to="about" smooth={false} duration={200}>Nosotros</Link></li>
          <li><Link to="gallery" smooth={false} duration={200}>Galeria</Link></li>
          <li><Link to="contact" smooth={false} duration={200}>Contacto</Link></li>
        </ul>
